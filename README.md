...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=JacobMenge&color=blue" alt="Profilaufrufe" />
</p>
...
- 📫 **Kontakt:** moin@jacob-decoded.de

Ich bin **Dozent und DevOps Engineer** mit einer Leidenschaft dafür, komplexe Tech-Themen verständlich zu machen. Ich baue Cloud-Infrastrukturen, entwickle KI-gestützte Workflows und bilde die nächste Generation von IT-Fachkräften aus – während ich als [@jacob.decoded](https://www.jacob-decoded.de) Tech- und KI-News für ein breites Publikum aufbereite.
...
| 🌐 Frontend | ⚙️ Backend | 🛢️ Datenbanken | ☁️ Cloud & DevOps | 🔄 CI/CD & Monitoring | 🔧 Tools | 🖥️ Betriebssysteme | 🔒 Netzwerk & Security |
|---|---|---|---|---|---|---|---|
